 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://examples/", wsdlLocation = "file:/E:/IrisWorkspace/SOAPDemo1_Client/src/myperson.wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://examples/", "PersonServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/E:/IrisWorkspace/SOAPDemo1_Client/src/myperson.wsdl");
    ...
    public PersonService getPersonServiceImplPort() {
        return super.getPort
        		(new QName("http://examples/", "PersonServiceImplPort"), 
        				PersonService.class);
    }
    ...
    public PersonService getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://examples/", "PersonServiceImplPort"), PersonService.class, features);
    }
